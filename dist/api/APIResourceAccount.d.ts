...
import { Account, AccountData, AccountSessionUsage, AccountSessionUsageSummary, AccountSessionUserUsage } from './models/Account';
...
export declare class APIResourceAccount extends APIResource<Account, QueryParams, AccountData> {
    ...
    userUsageDetails(): APIList<AccountSessionUserUsage, import("./models/HTTP").CollectionQueryParams, any>;
